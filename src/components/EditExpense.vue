      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form @submit.prevent="updateExpense">
            ...
            <div class="mb-3 form-floating">
              <select class="form-select" id="editPaymentMethod" v-model="editedExpense.selectedPaymentMethod" required>
            ...
            <div v-if="editedExpense.type === 'other'" class="mb-3 form-floating">
              <input type="text" class="form-control" id="editOtherType" v-model="editedExpense.otherType" required>
            ...
            <div v-if="editedExpense.category === 'other'" class="mb-3 form-floating">
              <input type="text" class="form-control" id="editOtherCategory" v-model="editedExpense.otherCategory"
                required>
